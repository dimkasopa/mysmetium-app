    ...
    <section className="document-selection">
      <div className="section-header">
        <div>
          ...
          <p className="muted">Мы разделили конструкторы, чтобы вы не путались.</p>
        </div>
            ...
            <div className="builder-preview">
              ...
              <div className="preview-card">
                ...
                <p className="preview-text">
                  Здесь будет выглядеть документ по мере заполнения.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="support-banner">
        <div>
          ...
          <p className="muted">1 месяц, 6 месяцев, 1 год — чем дольше, тем выгоднее.</p>
        </div>
